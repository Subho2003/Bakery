    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/10.webp" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1">Whoopie Pies</h1>
              <div class="flex mb-4">
              ...
              <p align="justify" class="leading-relaxed">These sandwich-style cookies are made with two soft, pillowy cookies and a marshmallow filling. Considered a Pennsylvania Amish tradition, legend has it that they're named after the exclamation children would make when they found them in their lunches. Today they are very popular in Maine, where whoopie pies were first sold. Traditionally chocolate cookies were used to make whoopie pies, but they've since expanded to everything from red velvet to pumpkin.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Whoopie Pies">
