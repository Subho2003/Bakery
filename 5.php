    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/5.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1">Peanut Butter Cookies</h1>
              <div class="flex mb-4">
              ...
              <p align="justify" class="leading-relaxed">A favorite for all the peanut butter lovers, these cookies are made with hand-rolled dough that is often flattened with a fork to achieve that familiar waffle pattern. This technique was first introduced in the 1933 edition of "Pillsbury's Balanced Recipes," and also helps to distinguish this cookie for those with peanut allergies.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Peanut Butter Cookies">
