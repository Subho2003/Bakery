    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="bi/17b.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1"> Brownie Cake</h1>
              <div class="flex mb-4">
              ...
              <p align="justify" class="leading-relaxed">This chocolate brownie cake that is truly decadent in taste & texture. It is irresistibly indulgent & oozing with deep chocolate flavour. It is topped with generous amount of melted chocolate sauce. It tastes extra delicious when served warm. There is a healthy alternative available for this cake which has no sugar or maida (refined flour) & is instead made with nuts, jaggery & quinoa (a dense grain that gives more antioxidants than other common grains).</p>
              <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              </div>
              <form action="cart.php" method="POST">
               <div class="flex">
                 <span class="title-font font-medium text-2xl text-gray-900">₹ 130.00</span>
                 ...
                 <input type="hidden" name="Item_name" value="Brownie Cake">
