    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/17.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1">Gingerbread Cookies</h1>
              <div class="flex mb-4">
              ...
              <p align="justify" class="leading-relaxed">It is also known as ginger nuts or ginger biscuits, these spicy treats are popular all around the world. Powdered ginger, cinnamon, molasses, and nutmeg make this popular holiday cookie the perfect blend of sweet and spicy.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Gingerbread Cookies">
