    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="bi/3b.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1"> Chocolate Volcano</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">556 Reviews</span>
                </span>
              </div>
              <p align="justify" class="leading-relaxed">A cake with a chocolaty soul, yes that sounds about right. A pinata cake like a ball of chocolate ready to be broken with a hammer has for you inside 4 Ferrero Rocher chocolates, 1 Kit Kat, Chocolate and golden balls, and the most lip-smacking small choco truffle cake. Savour the taste of this explicit cake one bite at a time. We think you could show this chocolaty cake a good time. Note: Hammer will be given with the cake.</p>
              <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              </div>
              <form action="cart.php" method="POST">
               <div class="flex">
                 <span class="title-font font-medium text-2xl text-gray-900">₹ 100.00</span>
                 ...
                 <input type="hidden" name="Item_name" value="Chocolate Volcano">
