    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="bi/5b.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1"> Mousse Cake</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">488 Reviews</span>
                </span>
              </div>
              <p align="justify"class="leading-relaxed">This chocolate mousse cake has a pure, real chocolaty taste and it's so decadent, like an expensive, good quality Swiss truffle filled with striking flavors coming from a unique fragrant indian spice blend. it gets richer with a generous amount of melt-in-mouth thandai mousse on the top. an amazing combination to celebrate indian flavors!!</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Mousse Cake">
