    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="bi/8b.webp" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1"> Cocount Cake</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">743 Reviews</span>
                </span>
              </div>
              <p align="justify"class="leading-relaxed">Put a fresh alternative on the table! indulge guests with this light cake that gorgeously adds some glamour to your event. vanilla cake layers with airy coconut swiss meringue This snow white cake comes with dried coconut shaving which makes its extra special the scrapings not only give cake aesthetic but also its distinct taste.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Cocount Cake">
