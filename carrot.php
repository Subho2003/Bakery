    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-20 mx-auto">
          <div class="lr:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="ice-cream/carrot cake ice cream.jpg" width="500" height="100">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 class="text-black-900 text-3xl title-font font-large mb-1">Carrot Cake Ice Cream</h1><br/>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">202 Reviews</span>
                </span><!--
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Carrot Cake Ice Cream">
