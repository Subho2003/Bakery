  ...
  <section class="text-black-600 body-font overflow-hidden">
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-5/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" src="bi/1b.jpg" width="500">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
          <h1 class="text-gray-900 text-3xl title-font font-large mb-1">Rainbow Mango Cake</h1>
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="text-black-600 ml-3">495 Reviews</span>
            </span>
          </div>
          <p align="justify"class="leading-relaxed">You’ve heard of the pineapple upside down cake, but how about mango? From the stunning fanned mango flower to the deliciously spicy taste, it’s hard to pass up on a slice of this beauty.<br/>If you’re a classic cake fan, you can’t go wrong with this vanilla mango delight. Filled with layers of delicious mango puree and topped with fresh slices, you really can’t go wrong with this one.</p>
          <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          </div>
            <form action="cart.php" method="POST">
               <div class="flex">
                 <span class="title-font font-medium text-2xl text-gray-900">₹ 70.00</span>
                 ...
                 <input type="hidden" name="Item_name" value="Rainbow Mango Cake">
