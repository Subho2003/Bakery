    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/1.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-black-900 text-3xl title-font font-large mb-1">Snickerdoodles Cookies</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">566 Reviews</span>
                </span>
              ...
              <p align="justify" class="leading-relaxed">Although the origin of this beloved cookie is up for debate, there's no doubt it's a favorite during the holidays. Snickerdoodles are a type of drop cookie (any cookie that is formed by dropping spoonfuls of dough directly onto a baking sheet) that is coated in cinnamon and sugar. They can be crisp or soft, with a slightly cracked surface.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Snickerdoodles Cookies">
