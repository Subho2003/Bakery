    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/42.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1">Meringue Cookies</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-black-500" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                  </svg>
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-black-500" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                  </svg>
                  <span class="text-black-600 ml-3">950 Reviews</span>
                </span>
              ...
              <p align="justify" class="leading-relaxed">Meringue Cookies is a type of dessert or candy, often associated with Swiss, French, Polish and Italian cuisines, traditionally made from whipped egg whites and sugar, and occasionally an acidic ingredient such as lemon, vinegar.Homemade meringues are often chewy and soft with a crisp exterior, while many commercial meringues are crisp throughout. A uniform crisp texture may be achieved at home by baking at a low temperature (80–90 °C or 176–194 °F) for an extended period of up to two hours.</p>
              <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              </div>
              <form action="cart.php" method="POST">
               <div class="flex">
                 <span class="title-font font-medium text-2xl text-gray-900">₹ 125.00</span>
                 ...
                 <input type="hidden" name="Item_name" value="Meringue Cookies">
