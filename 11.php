    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/12.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1">Molasses Cookies</h1>
              <div class="flex mb-4">
              ...
              <p align="justify" class="leading-relaxed">An offshoot of the popular holiday gingerbread cookies, molasses cookies are made with just as much ginger. Sometimes molasses is the sole sweetener in these cookies, and other times it's made with a mixture of sugar and molasses. They can come in either a soft, cake form or a chewier crinkle form (perfect for gifting).</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Molasses Cookies">
