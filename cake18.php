    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/39.jpg" width="400"height='300'>
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">Cake Type</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1">Red Velvet Cake</h1>
              <div class="flex mb-4">
