    ...
    <section class="text-black-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-5/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" src="c/16.jpg" width="500">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
              <h1 class="text-gray-900 text-3xl title-font font-large mb-1"> Drop Cookies</h1>
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <span class="text-black-600 ml-3">699 Reviews</span>
                </span>
              ...
              <p align="justify" class="leading-relaxed">A drop cookie is any cookie that's made by dropping spoonfuls of dough directly onto a baking sheet. This means lots of cookies can be drop cookies such as chocolate chip, oatmeal raisin, and more. They have a soft, cake-like texture and are extremely versatile.</p>
              ...
              <form action="cart.php" method="POST">
               <div class="flex">
                 ...
                 <input type="hidden" name="Item_name" value="Drop Cookies">
